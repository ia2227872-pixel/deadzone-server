...
wss.on('connection', function(ws) {
  ...
  ws.on('message', function(raw) {
    ...
    // ── POSITION BROADCAST ───────────────────────────────
      ...
      if (p) { p.x = msg.x; p.y = msg.y; p.z = msg.z; p.yaw = msg.yaw; if (msg.color != null) p.color = msg.color; }
      broadcast(room, { type: 'pos', id: playerId, x: msg.x, y: msg.y, z: msg.z, yaw: msg.yaw, color: msg.color }, playerId);
    }
